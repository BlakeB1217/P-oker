...
export default function ActionButtons({ disabled = false, actions = [], onAction }) {
  const styleMap = {
    ...
    bet_1: 'bg-amber-600 hover:bg-amber-500 text-white border-amber-500',
    bet_2: 'bg-amber-600 hover:bg-amber-500 text-white border-amber-500',
    bet_3: 'bg-amber-600 hover:bg-amber-500 text-white border-amber-500',
    bet_4: 'bg-amber-600 hover:bg-amber-500 text-white border-amber-500',
    bet_5: 'bg-amber-600 hover:bg-amber-500 text-white border-amber-500',
